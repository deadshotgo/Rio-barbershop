        ...
        <div class="master">
            ...
            <div class="info-master">
                <div class="master-name-hover">
                    <div class="master-info-text-block">
                        <h3>Ріо</h3>
                        <p>Барбер з 14 літнім стажем</p>
                        <p>Корекція бороди ,чистка обличчя та догляд за обличчям ,а також корекція брів ниткою ,фарбування та лікування волосся за допомогою Нанопластики ,Кератину та Ботоксу для волосся.</p>
                    </div>
                </div>
                <img src="img/rio-master.jpg" alt="">
            </div>
        </div>
        <div class="master">
            <div class="info-master">
                <div class="master-name-hover">
                    <div class="master-info-text-block">
                        <h3>Ірина</h3>
                        <p>Я барбер, стаж роботи рік</p>
                        <p>Закончила курсы барбера в «Rival». Все виды стрижек. Коррекция бороды. Чистка и уход за лицом </p>
                    </div>
                </div>
                <img src="img/iraMaster.jpg" alt="">
            </div>
            <div class="info-master">
                <div class="master-name-hover">
                    <div class="master-info-text-block">
